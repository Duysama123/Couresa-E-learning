            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 bg-blue-600 p-8 flex flex-col justify-between text-white relative overflow-hidden">
                    <div className="z-10">
                        ...
                        <p className="text-blue-100">Continue your learning journey with Couresa.</p>
                    </div>
                    <div className="z-10">
                        <p className="mb-4 text-sm opacity-90">"Education is the passport to the future, for tomorrow belongs to those who prepare for it today."</p>
                        <p className="text-xs font-bold">- Malcolm X</p>
                    </div>
                    {/* Abstract Shapes */}
